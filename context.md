...
├── docs/
│   └── screenshots/week-04/        # Manual lab screenshots (user-provided)
...
| Lab screenshots | Pending — user will capture manually to `docs/screenshots/week-04/` |
...
- Screenshots will be added manually by the developer to `docs/screenshots/week-04/`
